...
teoretickou èást pøelo¾il: Michal Turek - Woq <?VypisEmail('woq@email.cz');?><br />
praktickou èást pøelo¾il: Václav Slováèek - Wessan <?VypisEmail('horizont@host.sk');?></p>
